...
#2. Funciones para muestrear los parámetros ----
...
matplot(ALPHA, type = "l", lty = 1, main = "ALPHA")
matplot(BETA, type = "l", lty = 1, main = "ALPHA")
matplot(MU, type = "l", lty = 1, main = "ALPHA")
matplot(SIGMA, type = "l", lty = 1, main = "ALPHA")




boxplot(colMeans(SIGMA_K))
boxplot(colMeans(ZETA))
boxplot(colMeans(THETA))
boxplot(colMeans(KAPPA_JK))
boxplot(colMeans(ZETA))


plot(LL$V1)

summary(coda::effectiveSize(ZETA))
summary(coda::effectiveSize(KAPPA_JK))
summary(coda::effectiveSize(THETA))
summary(coda::effectiveSize(SIGMA_K))
summary(coda::effectiveSize(KAPPA_K))
summary(coda::effectiveSize(MU))
summary(coda::effectiveSize(TAU))
summary(coda::effectiveSize(SIGMA))
summary(coda::effectiveSize(ALPHA))
summary(coda::effectiveSize(BETA))
...
sd(BETA$V1)/sqrt(coda::effectiveSize(BETA))*100
